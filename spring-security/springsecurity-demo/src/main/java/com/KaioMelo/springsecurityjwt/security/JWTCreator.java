...
public class JWTCreator {
    ...
    public static String create(String prefix,String key, dio.dio.spring.security.jwt.security.JWTObject jwtObject) {
    ...
    public static dio.dio.spring.security.jwt.security.JWTObject create(String token, String prefix, String key)
            throws ExpiredJwtException, UnsupportedJwtException, MalformedJwtException, SignatureException {
        dio.dio.spring.security.jwt.security.JWTObject object = new dio.dio.spring.security.jwt.security.JWTObject();
